...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    navHome: "Home",
    navGis: "0–3h Street GIS",
    navSafeNav: "Citizen Safe Routes",
    navEmergency: "Emergency Helplines",
    navBulletins: "Disaster Bulletins",
    navMoES: "MoES Console",
    aiBtn: "AI Assistant",
  ...
  bn: {
    ...
    navHome: "হোম",
    navGis: "০–৩ ঘণ্টা লাইভ GIS",
    navSafeNav: "নিরাপদ বিকল্প রুট",
    navEmergency: "জরুরি হেল্পলাইন",
    navBulletins: "সরকারি বুলেটিন",
    navMoES: "অফিসিয়াল কনসোল",
    aiBtn: "AI অ্যাসিস্ট্যান্ট",
    loginBtn: "অফিসিয়াল লগইন",
  ...
  hi: {
    ...
    navHome: "होम",
    navGis: "0–3 घंटे लाइव GIS",
    navSafeNav: "सुरक्षित नेविगेशन",
    navEmergency: "आपातकालीन हेल्पलाइन",
    navBulletins: "आपदा बुलेटिन",
    navMoES: "अधिकारी कंसोल",
    aiBtn: "AI सहायक",
    loginBtn: "आधिकारिक लॉगिन",
    locateMe: "मेरा स्थान",
